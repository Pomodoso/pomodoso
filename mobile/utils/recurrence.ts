...
// Ported verbatim from extension/src/recurrence.ts — pure date-math, no DOM,
// so it's directly portable. IMPORTANT: RecurrenceRule.weekdays uses JS
// Date#getDay()'s 0=Sun..6=Sat convention, NOT the 0=Mon..6=Sun convention
// used everywhere else in mobile (habit.days, settings.weekStart/workDays —
// see constants/habitDays.ts). Keep this straight when building the
// recurrence form UI.
